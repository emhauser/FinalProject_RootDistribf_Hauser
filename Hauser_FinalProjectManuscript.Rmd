...
```{r CaFigs, echo=F, fig.cap="Figure 5. "}

HWDeep<-HWSoilDat[100:175,]
par(mfrow = c(1,1))
plot(HWDeep$Roots~HWDeep$Ca, col = depth_colTot, cex.axis = 1.25, cex.lab = 1.5, pch = 19, main = "Deep", ylab = "Fraction of Roots, Hardwood(%)", xlab = "Ca (%)")
...
```{r PdepthShift, echo=F, fig.cap="Figure 6."}
```
